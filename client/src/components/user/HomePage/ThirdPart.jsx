    ...
    <AnimatePresence>
      ...
      <motion.div className="wrapper w-full bg-primary h-[30vh] overflow-hidden mt-10  mb-10"
        ...
        <motion.div className="w-[50%] font-info m-auto text-center flex  flex-col gap-5"
          ...
          <p className='font-info'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsum adipisci ducimus, excepturi quibusdam voluptate quas labore porro ipsam nisi autem </p>
